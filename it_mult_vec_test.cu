...
const char * itmv_test5() {
  return itmv_test(
      "Test 5:n=4, t=1, 1x2 threads/shared mem", TEST_CORRECTNESS, 4, !UPPER_TRIANGULAR, 1, 1, 2,
      !USE_ASYNC, USE_SHARED_X);
}

const char * itmv_test6() {
  return itmv_test(
      "Test 6:n=4, t=2, 1x2 threads/shared mem", TEST_CORRECTNESS, 4, !UPPER_TRIANGULAR, 2, 1, 2,
      !USE_ASYNC, USE_SHARED_X);
}
const char * itmv_test7() {
  return itmv_test(
      "Test 7:n=8, t=1, 1x2 threads/shared  with shared mem", TEST_CORRECTNESS, 8, !UPPER_TRIANGULAR, 1, 1, 2,
      !USE_ASYNC, USE_SHARED_X);
}
const char * itmv_test8() {
  return itmv_test(
      "Test 8:n=8, t=2, 1x2 threads/shared mem", TEST_CORRECTNESS, 8, !UPPER_TRIANGULAR, 2, 1, 2,
      !USE_ASYNC, USE_SHARED_X);
}
...
void run_basic_tests(void){
  ...
  /*
   * Basic correctness tests with shared memory
   */
...
void run_large_matrix_tests(void){
  ...
  /*
   * Large matrix tests with shared memory.
   */
  mu_run_test(itmv_test10);
  mu_run_test(itmv_test10a); 
